...
|Task 3. Initiate the linkage of In-Stream Nutrient kinetics with GSSHA (build upon work done with HEC-RAS-1D): a. Modify existing in-stream nutrient model to run stand-alone.|**~ Progress report:** document current status of in-stream nutrient model and work that needs to be done to finalize it.  **~ Software:** in-stream nutrient model|9/30/2020||
...
|Task 6. Develop and implement plan to link GSSHA-WQ with ERDC's multi-species vegetation model - Aquatic Plants: a. Determine proper flow, sediment, and water quality information that needs to be stored by GSSHA-Water Quality and develop and implement plan to link GSSHA-WQ with ERDC's multi-species vegetation model - Aquatic Plant model.|**~ TN:** design plan for linking GSSHA-WQ with ERDC Multi-Species Vegetation Model - Aquatic Vegetation  **~ Software:** Updated GSSHA and Nutrient Models able to provide the needed information to drive the ERDC Multi-Species Vegetation Model: Aquatic Vegetation|3/31/2022||
|Task 6. Develop and implement plan to link GSSHA-WQ with ERDC's multi-species vegetation model - Aquatic Plants: b. Finalize and test data storage and retrieval between GSSHA and the Aquatic Plant model.|**~ TN:** Database design plan for storing the necessary aquatic vegetation data  **~ Software:** Updated database for Aquatic Vegetation|6/30/2022||
...
|Task 7. Develop and implement plan to link GSSHA-WQ with ERDC's multi-species vegetation model - Terrestrial Plants: a. Determine proper flow, sediment, and water quality information that needs to be stored by GSSHA-Water Quality and develop and implement plan to link GSSHA-WQ with ERDC's multi-species vegetation model - Terrestrial Plant model|**~ TN:** design plan for linking GSSHA-WQ with ERDC Multi-Species Vegetation Model - Terrestrial Vegetation  **~ Software:** Updated GSSHA and Nutrient Models able to provide the needed information to drive the ERDC Multi-Species Vegetation Model - Terrestrial Vegetation|3/31/2023||
|Task 7. Develop and implement plan to link GSSHA-WQ with ERDC's multi-species vegetation model - Terrestrial Plants: b. Finalize and test data storage and retrieval between GSSHA and the Terrestrial Plant model.|**~ TN:** Database design plan for storing the necessary terrestrial vegetation data  **~ Software:** Updated database for Terrestrial Vegetation|6/30/2023||
